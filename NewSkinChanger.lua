...
for i,v in pairs(TClone:GetChildren())do
    if table.find(EquipSkin["TFolder"],v.Name) then
       v.Value = EquipSkin["TFolder"][v.Name]
    end
end

for i,v in pairs(CTClone:GetChildren())do
    if table.find(EquipSkin["TFolder"],v.Name) then
       v.Value = EquipSkin["TFolder"][v.Name]
    end
end
